...
### Changed
- Test helpers (`blackboxBinary`, `buildConformanceBinary`) now append `.exe` suffix on Windows for cross-platform test compatibility.
- ADR-0003 status updated to `Superseded by ADR-0005`.
