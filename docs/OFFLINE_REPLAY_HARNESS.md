...
This command consumes the harness-owned governed official family artifacts from
the adjacent `jcs-conformance-harness` checkout, or from `JCS_CONFORMANCE_REPO`
when set.
