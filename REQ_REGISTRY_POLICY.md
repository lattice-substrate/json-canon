...
| AWS-GATE-001 | CONTRIBUTING.md + .github/workflows/release.yml | Release Process | MUST | Official release gating MUST require `evidence.v3` for both x86_64 and arm64 AWS evidence artifacts, MUST bind `JCS_OFFLINE_INFRA_MANIFEST`, and MUST NOT accept `evidence.v1` or `evidence.v2` as an official AWS release substitute. |
