...
| AWS-AMI-001 | infra/aws_release_hosts.json + infra/instances.tf | Infrastructure Selectors | MUST | Official AWS release host selectors MUST be stable and explicit. Ubuntu host entries MUST resolve AMIs through Canonical public SSM parameter paths instead of brittle name globs, and the catalog MUST NOT declare unsupported Ubuntu 20.04 minimal ARM64 lanes. |
