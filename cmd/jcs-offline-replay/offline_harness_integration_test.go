...
func TestCompareCrossArchEvidence_MismatchReturnsError(t *testing.T) {
	...
	x86 := &replay.EvidenceBundle{
		...
		BundleSHA256:       testDigestSHA256,
		ControlBinarySHA:   testDigestSHA256,
		MatrixSHA256:       testDigestSHA256,
		ProfileSHA256:      testDigestSHA256,
		VectorSetSHA256:    testDigestSHA256,
		SourceGitCommit:    strings.Repeat("a", 40),
		SourceGitTag:       "v0.0.0-test",
		...
		NodeReplays: []replay.NodeRunEvidence{{
			...
			CaseCount:          1,
			Passed:             true,
			CanonicalSHA256:    testDigestSHA256,
			VerifySHA256:       testDigestSHA256,
			FailureClassSHA256: testDigestSHA256,
			ExitCodeSHA256:     testDigestSHA256,
		}},
	}
	arm := &replay.EvidenceBundle{
		...
		NodeReplays: []replay.NodeRunEvidence{{
			...
			Passed:             true,
			CanonicalSHA256:    testDigestSHA256,
			VerifySHA256:       strings.Repeat("b", 64),
			FailureClassSHA256: testDigestSHA256,
			ExitCodeSHA256:     testDigestSHA256,
		}},
	}
